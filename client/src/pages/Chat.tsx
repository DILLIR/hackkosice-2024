...
import { Archive, ArrowLeft, BrandGithub, Code, Download, Folder, Star } from '@mynaui/icons-react';
...
export function Chat() {
    ...
    const [form, setForm] = useState({
        server: 'http://localhost:3000/processRepo',
        description: '',
        desiredAction: 'Change all php code to python code, and answer ONLY! updated code',
                                    ...
                                    <div className='flex-col justify-start items-start gap-8 flex'>
                                        <div className='w-[100%]'>
                                            ...
                                            <span className="text-slate-800 text-lg font-normal font-['Inter'] leading-relaxed">
                                                ...
                                                errors, please let me know, and I'll be happy to
                                                assist you in ensuring that the code works as
                                                intended.
                                            </span>
                                        </div>
